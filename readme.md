...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/TreatedRightAwayAndDeath/inst/doc/UsingSkeletonPackage.pdf)

Instructions To Prepare Package Outside Atlas
===================

- Step 1: Change package name, readme and description (replace (TreatedRightAwayAndDeath with the package name)
...
- Share the package by adding it to the OHDSI/StudyProtocolSandbox github repo and get people to install by running but replace 'TreatedRightAwayAndDeath' with your study name if not using atlas:
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/TreatedRightAwayAndDeath")
```

- Get users to execute the study by running the code in (extras/CodeToRun.R) but replace 'TreatedRightAwayAndDeath' with your study name:
```r
  library(TreatedRightAwayAndDeath)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./TreatedRightAwayAndDeathResults"
...
cohortTable <- 'TreatedRightAwayAndDeathCohort'
#=======================
...
viewShiny('TreatedRightAwayAndDeath')
