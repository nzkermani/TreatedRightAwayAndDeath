...
#
# This file is part of TreatedRightAwayAndDeath
#
...
#'
#' @details
#' This function executes the TreatedRightAwayAndDeath Study.
#' 
...
execute <- function(connectionDetails,
                    ...
                    runAnalyses = F,
                    createResultsDoc = F,
                    createValidationPackage = 'TreatedRightAwayAndDeath',
  ...
  if (createCohorts) {
    ...
    createCohorts(connectionDetails = connectionDetails,
                  ...
                  outputFolder = 'TreatedRightAwayAndDeath')
  }
  ...
  if(runAnalyses){
    ...
    predictionAnalysisListFile <- system.file("settings",
                                              ...
                                              package = "TreatedRightAwayAndDeath")
