...
createAnalysesDetails <- function(workFolder) {
  ...
  # ADD COHORTS
  cohortIds <- c(1,2,3,41,25)  # add all your Target cohorts here
  outcomeIds <- c(2,3,41,25)   # add all your outcome cohorts here
  
 # 3,3,Death
 #  41,41,PIONEER_2_PCa_Treated_Right_Away_broad
 #  25,25,All_Prostate_cancer_patients_from_first_diagnosis
