...
OhdsiRTools::checkUsagePackage("TreatedRightAwayAndDeath")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/TreatedRightAwayAndDeath.pdf")
shell("R CMD Rd2pdf ./ --output=extras/TreatedRightAwayAndDeath.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "TreatedRightAwayAndDeath")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("TreatedRightAwayAndDeath")
